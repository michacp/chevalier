...
export class ServiceandcutsComponent {
  ...
  ngOnInit() {
    ...
    this.corteForm = this.fb.group({
      ...
      descuentoBuscador: [''],
      observaciones: [''],
      formaPagoBuscador: [''], // Agregar el control para forma de pago
...
eliminarServicio(element: any): void {
  ...
  onSubmit() {
    if (this.corteForm.valid) {
      console.log('Datos del corte:', this.corteForm.value);
      console.log('Servicios agregados:', this.serviciosAgregados);
